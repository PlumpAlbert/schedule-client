	...
	return (
		<div className="page landing-page">
			...
			<p className="landing-page__text app-description">
				Постоянно забываешь какой предмет следующий по расписанию? С этим приложением
				расписание твоей группы всегда под рукой! Воспользуйся поиском интересующей группы
				или открой список всех доступных групп, нажав кнопку ниже:
			</p>
			<Button className="landing-page__btn" onClick={groupBtnClick}>
				Список групп
			</Button>
			<p className="landing-page__text">
				Надоело вечно искать свою группу? Зарегистрируйся, чтобы видеть только расписание
				своей группы
			</p>
